<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="DeatilProducts.aspx.cs" Inherits="WebSiteVanGia.DeatilProducts" %>
...
<%@ Register Src="~/ctr/ctr_post_fb_products.ascx" TagPrefix="uc1" TagName="ctr_post_fb_products" %>



<asp:Content ID="Content8" ContentPlaceHolderID="ct_post_fb" runat="server">
    <uc1:ctr_post_fb_products runat="server" ID="ctr_post_fb_products" />
</asp:Content>
