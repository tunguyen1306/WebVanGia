<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="WebForm3.aspx.cs" Inherits="WebSiteVanGia.WebForm3" %>
        ...
        <div class="row-container">
            ...
            <div>
               <%-- <img u="image" src="../img/home/01.jpg">--%>
                <div u="caption" t="CLIP|LR" du="1500" class="captionOrange" style="position: absolute; left: 20px; top: 30px; width: 1300px; height: 50px;">
                    <span class="tencongty" style="font-size:35px;width:auto;line-height:50px;font-weight:bold;"></span>
                </div>
               
               
                <div u="caption" t="RTT|360" d="-200" class="captionBlack" style="position: absolute; text-align:left;left: 20px; top: 100px; width: auto; height: auto;white-space:pre-line;">
                    <span class="ttphuonghuong" style="font-size:24px;width:auto;text-align:left;font-weight:bold;"></span>
                </div>
            ...
            <div>
               <%-- <img u="image" src="../img/home/04.jpg">--%>
                ...
                <div u="caption" t="T|IB" t2="T" d="-300" class="captionOrange" style="position: absolute; text-align:left;;left: 20px; top: 100px; width: auto; height: auto;white-space:pre-line;">
                    <span class="ttphuonghuong" style="font-size:24px;width:auto;text-align:left;font-weight:bold;"></span>
                </div>
